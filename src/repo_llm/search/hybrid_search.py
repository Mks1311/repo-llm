...
def hybrid_search(query, method, repo_name, n_results=10, candidate_pool_size=20, k=RRF_K):
    """
    ...
    ranked_ids = sorted(fused, key=lambda id_: fused[id_]["rrf_score"], reverse=True)[:n_results]
